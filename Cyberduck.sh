...
## This Script is designed to install the latest version of Any Application you can manually download from the internet and install on Mac OS X
##Simply Change the following variables to match the application you want to install
##Produced by Zach Perry for PathAI IT

# User Defined variables
weburl="https://update.cyberduck.io/Cyberduck-8.7.2.40975.zip"                  
appname="Cyberduck"                                                              # The name of our App deployment script (also used for Octory monitor)
app="Cyberduck.app"                                                              # The actual name of our App once installed
logandmetadir="/Library/Logs/Microsoft/IntuneScripts/cyberduck"                  # The location of our logs and last updated data
processpath="/Applications/Cyberduck.app/Contents/MacOS/Cyberduck"               # The process name of the App we are installing
